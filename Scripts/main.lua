...
local function LoadWebserver()
  local status, err = pcall(function()
    ...
    server.registerHandler("/players/*/exp", "POST", playerManager.HandleTransferExpToPlayer)
    ...
    server.registerHandler("/players/*/diag/navigation", "GET", playerManager.HandleDiagNavigation)
    ...
    server.registerHandler("/players/*/knockdown", "POST", playerManager.HandleKnockdownPlayer)
    ...
    server.registerHandler("/houses/*/buy", "POST", propertyManager.HandleBuyHouse)
    ...
    server.registerHandler("/player_vehicles/*/last/parts", "PUT", vehicleManager.HandleSetPlayerLastVehicleParts)
    ...
    server.registerHandler("/player_vehicles/*/counts", "GET", vehicleManager.HandleGetPlayerVehicleCounts)
    server.registerHandler("/vehicles/*", "GET", vehicleManager.HandleGetVehicles)
    server.registerHandler("/vehicles/*", "PATCH", vehicleManager.HandleSetVehicleParameter)
    ...
    server.registerHandler("/player_vehicles/*/despawn_spawned_vehicle", "POST", vehicleManager.HandleDespawnSpawnedVehicleById)
    ...
    server.registerHandler("/player_vehicles/*/capture_vehicle", "POST", vehicleManager.HandleCaptureVehicle)
    server.registerHandler("/player_vehicles/*/apply_captured_vehicle", "POST", vehicleManager.HandleApplyCapturedVehicle)
