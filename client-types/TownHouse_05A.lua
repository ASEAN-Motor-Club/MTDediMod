...
---@class ATownHouse_05A_C : AMTBuilding
...
local ATownHouse_05A_C = {}

function ATownHouse_05A_C:TurnMaterial() end
ATownHouse_05A_C['Town House'] = function(self, ) end
function ATownHouse_05A_C:UserConstructionScript() end
---@param DeltaSeconds float
function ATownHouse_05A_C:ReceiveTick(DeltaSeconds) end
---@param EntryPoint int32
function ATownHouse_05A_C:ExecuteUbergraph_TownHouse_05A(EntryPoint) end
