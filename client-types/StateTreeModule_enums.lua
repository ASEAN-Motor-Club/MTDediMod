...
local EStateTreeBlueprintPropertyCategory = {
    NotSet = 0,
    Input = 1,
    Parameter = 2,
    Output = 3,
...
local EStateTreeBreakpointType = {
    Unset = 0,
    OnEnter = 1,
    OnExit = 2,
    OnTransition = 3,
...
local EStateTreeConditionEvaluationMode = {
    Evaluated = 0,
    ForcedTrue = 1,
    ForcedFalse = 2,
...
local EStateTreeExpressionOperand = {
    Copy = 0,
    And = 1,
    Or = 2,
...
local EStateTreeExternalDataRequirement = {
    Required = 0,
    Optional = 1,
...
local EStateTreePropertyAccessType = {
    Offset = 0,
    Object = 1,
    WeakObject = 2,
    SoftObject = 3,
...
local EStateTreePropertyCopyType = {
    None = 0,
    CopyPlain = 1,
    CopyComplex = 2,
    CopyBool = 3,
...
local EStateTreeRecordTransitions = {
    No = 0,
    Yes = 1,
...
local EStateTreeSelectionFallback = {
    None = 0,
...
local EStateTreeTransitionSourceType = {
    Unset = 0,
    Asset = 1,
    ExternalRequest = 2,
    Internal = 3,
