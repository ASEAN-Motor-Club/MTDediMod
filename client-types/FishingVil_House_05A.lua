...
---@class AFishingVil_House_05A_C : AMTBuilding
...
local AFishingVil_House_05A_C = {}

function AFishingVil_House_05A_C:TurnMaterial() end
AFishingVil_House_05A_C['Fishing Vil House'] = function(self, ) end
function AFishingVil_House_05A_C:UserConstructionScript() end
---@param DeltaSeconds float
function AFishingVil_House_05A_C:ReceiveTick(DeltaSeconds) end
---@param EntryPoint int32
function AFishingVil_House_05A_C:ExecuteUbergraph_FishingVil_House_05A(EntryPoint) end
