...
---@class AFishingVil_House_02_C : AMTBuilding
...
local AFishingVil_House_02_C = {}

function AFishingVil_House_02_C:TurnMaterial() end
AFishingVil_House_02_C['Fishing Vil House'] = function(self, ) end
function AFishingVil_House_02_C:UserConstructionScript() end
---@param DeltaSeconds float
function AFishingVil_House_02_C:ReceiveTick(DeltaSeconds) end
---@param EntryPoint int32
function AFishingVil_House_02_C:ExecuteUbergraph_FishingVil_House_02(EntryPoint) end
