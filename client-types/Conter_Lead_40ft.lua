...
---@class AConter_Lead_40ft_C : AMTVehicleBaseBP_C
---@field CargoSpace UMTVehicleCargoSpaceComponent
---@field UnhookLever UStaticMeshComponent
---@field MTTrailerHitch UMTTrailerHitchComponent
---@field ['5ThWheelDoor'] UMTVehicleDoorComponent
---@field ReverseLight_011 UReverseLight_01_C
---@field UnHookInteraction UMTInteractableComponent
---@field UnHookSphere USphereComponent
