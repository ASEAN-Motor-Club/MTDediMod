...
---@class ATownHouse_02A_C : AMTBuilding
...
local ATownHouse_02A_C = {}

function ATownHouse_02A_C:TurnMaterial() end
ATownHouse_02A_C['Town House'] = function(self, ) end
function ATownHouse_02A_C:UserConstructionScript() end
---@param DeltaSeconds float
function ATownHouse_02A_C:ReceiveTick(DeltaSeconds) end
---@param EntryPoint int32
function ATownHouse_02A_C:ExecuteUbergraph_TownHouse_02A(EntryPoint) end
