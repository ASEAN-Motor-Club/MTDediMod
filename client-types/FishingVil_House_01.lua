...
---@class AFishingVil_House_01_C : AMTBuilding
...
local AFishingVil_House_01_C = {}

function AFishingVil_House_01_C:TurnMaterial() end
AFishingVil_House_01_C['Fishing Vil House'] = function(self, ) end
function AFishingVil_House_01_C:UserConstructionScript() end
---@param DeltaSeconds float
function AFishingVil_House_01_C:ReceiveTick(DeltaSeconds) end
---@param EntryPoint int32
function AFishingVil_House_01_C:ExecuteUbergraph_FishingVil_House_01(EntryPoint) end
