...
---@class ATownHouse_06_C : AMTBuilding
...
local ATownHouse_06_C = {}

function ATownHouse_06_C:TurnMaterial() end
ATownHouse_06_C['Town House'] = function(self, ) end
function ATownHouse_06_C:UserConstructionScript() end
---@param DeltaSeconds float
function ATownHouse_06_C:ReceiveTick(DeltaSeconds) end
---@param EntryPoint int32
function ATownHouse_06_C:ExecuteUbergraph_TownHouse_06(EntryPoint) end
