...
---@class FValueOrBBKey_Bool : FValueOrBlackboardKeyBase
---@field DefaultValue boolean
local FValueOrBBKey_Bool = {}



---@class FValueOrBBKey_Class : FValueOrBlackboardKeyBase
---@field DefaultValue UClass
---@field BaseClass UClass
local FValueOrBBKey_Class = {}



---@class FValueOrBBKey_Enum : FValueOrBlackboardKeyBase
---@field DefaultValue uint8
---@field EnumType UEnum
---@field NativeEnumTypeName FString
local FValueOrBBKey_Enum = {}



---@class FValueOrBBKey_Float : FValueOrBlackboardKeyBase
---@field DefaultValue float
local FValueOrBBKey_Float = {}
...
---@class FValueOrBBKey_Name : FValueOrBlackboardKeyBase
---@field DefaultValue FName
local FValueOrBBKey_Name = {}



---@class FValueOrBBKey_Object : FValueOrBlackboardKeyBase
---@field DefaultValue UObject
---@field BaseClass UClass
local FValueOrBBKey_Object = {}



---@class FValueOrBBKey_Rotator : FValueOrBlackboardKeyBase
---@field DefaultValue FRotator
...
---@class FValueOrBBKey_Struct : FValueOrBlackboardKeyBase
---@field DefaultValue FInstancedStruct
local FValueOrBBKey_Struct = {}



---@class FValueOrBBKey_Vector : FValueOrBlackboardKeyBase
---@field DefaultValue FVector
local FValueOrBBKey_Vector = {}



---@class FValueOrBlackboardKeyBase
---@field Key FName
local FValueOrBlackboardKeyBase = {}
...
---@param RequireNavigableEndLocation EAIOptionFlag::Type
---@return UAITask_MoveTo
function UAITask_MoveTo:AIMoveTo(Controller, GoalLocation, GoalActor, AcceptanceRadius, StopOnOverlap, AcceptPartialPath, bUsePathfinding, bLockAILogic, bUseContinuousGoalTracking, ProjectGoalOnNavigation, RequireNavigableEndLocation) end
...
---@field ConeHalfAngle FValueOrBBKey_Float
...
---@field CoolDownTime FValueOrBBKey_Float
...
---@field PathQueryType FValueOrBBKey_Enum
---@field FilterClass FValueOrBBKey_Class
...
---@field bUseNavAgentGoalLocation FValueOrBBKey_Bool
---@field bPathFindingBasedTest FValueOrBBKey_Bool
local UBTDecorator_IsAtLocation = {}



---@class UBTDecorator_IsBBEntryOfClass : UBTDecorator_BlackboardBase
---@field TestClass FValueOrBBKey_Class
...
---@field NumLoops FValueOrBBKey_Int32
---@field bInfiniteLoop boolean
---@field InfiniteLoopTimeoutTime FValueOrBBKey_Float
...
---@field CooldownDuration FValueOrBBKey_Float
---@field bAddToExistingDuration FValueOrBBKey_Bool
...
---@field CooldownDuration FValueOrBBKey_Float
---@field bAddToExistingDuration FValueOrBBKey_Bool
---@field bActivatesCooldown FValueOrBBKey_Bool
local UBTDecorator_TagCooldown = {}



---@class UBTDecorator_TimeLimit : UBTDecorator
---@field TimeLimit FValueOrBBKey_Float
...
---@field AcceptableRadius FValueOrBBKey_Float
---@field FilterClass FValueOrBBKey_Class
---@field ObservedBlackboardValueTolerance FValueOrBBKey_Float
---@field bAllowStrafe FValueOrBBKey_Bool
---@field bAllowPartialPath FValueOrBBKey_Bool
---@field bTrackMovingGoal FValueOrBBKey_Bool
---@field bRequireNavigableEndLocation FValueOrBBKey_Bool
---@field bProjectGoalLocation FValueOrBBKey_Bool
---@field bReachTestIncludesAgentRadius FValueOrBBKey_Bool
---@field bReachTestIncludesGoalRadius FValueOrBBKey_Bool
---@field bStartFromPreviousPath FValueOrBBKey_Bool
...
---@field AnimationToPlay FValueOrBBKey_Object
---@field bLooping FValueOrBBKey_Bool
---@field bNonBlocking FValueOrBBKey_Bool
...
---@field SoundToPlay FValueOrBBKey_Object
...
---@field Precision FValueOrBBKey_Float
...
---@field WaitTime FValueOrBBKey_Float
---@field RandomDeviation FValueOrBBKey_Float
local UBTTask_Wait = {}
...
---@field DefaultValue FRotator
---@field bUseDefaultValue boolean
...
---@class UBlackboardKeyType_Struct : UBlackboardKeyType
---@field DefaultValue FInstancedStruct
---@field Value FInstancedStruct
local UBlackboardKeyType_Struct = {}
...
---@field OnSmartLinkReached FGeneratedNavLinksProxyOnSmartLinkReached
