...
---@class AMammoth_C : AMTVehicleBaseBP_C
---@field DashboardCluster UStaticMeshComponent
...
---@field DomeLightSlot UMTVehiclePartSlotComponent
...
---@field DiffCenter UMTDifferentialComponent
