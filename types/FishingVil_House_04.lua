...
---@class AFishingVil_House_04_C : AMTBuilding
...
local AFishingVil_House_04_C = {}

function AFishingVil_House_04_C:TurnMaterial() end
AFishingVil_House_04_C['Fishing Vil House'] = function(self, ) end
function AFishingVil_House_04_C:UserConstructionScript() end
---@param DeltaSeconds float
function AFishingVil_House_04_C:ReceiveTick(DeltaSeconds) end
---@param EntryPoint int32
function AFishingVil_House_04_C:ExecuteUbergraph_FishingVil_House_04(EntryPoint) end
