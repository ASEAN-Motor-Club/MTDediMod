...
---@class ABrutus_FireEngine_C : AMTVehicleBaseBP_C
---@field HoseDoor UMTVehicleDoorComponent
---@field MTWaterHose UMTWaterHoseComponent
---@field MTVehicleFireFighting UMTVehicleFireFightingComponent
---@field WaterSpray1 UMTWaterSprayComponent
---@field WaterCannon_Pitch UMTVehicleDoorComponent
---@field WaterCannon_Yaw UMTVehicleDoorComponent
---@field MTTankerFuelPump UMTTankerFuelPumpComponent
---@field MTInteractable UMTInteractableComponent
---@field Pump UStaticMeshComponent
---@field PumpDoor UMTVehicleDoorComponent
