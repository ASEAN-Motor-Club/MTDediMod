...
---@class ANeutz_Light_Square6_C : AActor
---@field RectLight5 URectLightComponent
---@field SquareLight5 UStaticMeshComponent
---@field RectLight4 URectLightComponent
---@field SquareLight4 UStaticMeshComponent
...
---@field SquareLight3 UStaticMeshComponent
---@field SquareLight2 UStaticMeshComponent
---@field SquareLight1 UStaticMeshComponent
---@field RectLight URectLightComponent
---@field MTInteractable UMTInteractableComponent
---@field SquareLight UStaticMeshComponent
---@field DefaultSceneRoot USceneComponent
local ANeutz_Light_Square6_C = {}
