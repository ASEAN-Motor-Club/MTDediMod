...
---@field Server_EscortCargo AMTCargo
...
---@field Server_InValidEscortStateTimeSeconds double
...
---@class UDailyTradeStatsEntryWidget : UMTListViewEntryWidget
---@field StatsTextBlock URichTextBlock
...
---@field BeginnerHitchhiker AMTCharacter
...
---@class UMTDailyTradeStatsListObject : UObject
local UMTDailyTradeStatsListObject = {}
...
---@field LocationPanel UPanelWidget
---@field LocationGroup UMTTransformStepWidget
---@field RotationPanel UPanelWidget
...
---@field DailyTradeStatsListView UMTListView
