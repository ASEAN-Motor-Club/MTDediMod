...
---@class AFishingVil_House_03_C : AMTBuilding
...
local AFishingVil_House_03_C = {}

function AFishingVil_House_03_C:TurnMaterial() end
AFishingVil_House_03_C['Fishing Vil House'] = function(self, ) end
function AFishingVil_House_03_C:UserConstructionScript() end
---@param DeltaSeconds float
function AFishingVil_House_03_C:ReceiveTick(DeltaSeconds) end
---@param EntryPoint int32
function AFishingVil_House_03_C:ExecuteUbergraph_FishingVil_House_03(EntryPoint) end
