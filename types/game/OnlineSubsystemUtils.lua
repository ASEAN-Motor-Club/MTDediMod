...
---@class AOnlineBeaconUnitTestClient : AOnlineBeaconClient
local AOnlineBeaconUnitTestClient = {}
...
---@class AOnlineBeaconUnitTestHostObject : AOnlineBeaconHostObject
local AOnlineBeaconUnitTestHostObject = {}
...
---@class FOnlineAccountStoredCredentials
---@field ID FString
---@field Token FString
---@field Type FString
---@field TokenBytes TArray<uint8>
local FOnlineAccountStoredCredentials = {}
...
---@field OnWriteSuccess FAchievementWriteCallbackProxyOnWriteSuccess
---@field OnWriteFailure FAchievementWriteCallbackProxyOnWriteFailure
...
function UCreateSessionCallbackProxy:CreateSession(WorldContextObject, PlayerController, PublicConnections, bUseLAN, bUseLobbiesIfAvailable) end
...
---@param bUseLAN boolean
---@param bUseLobbies boolean
---@return UFindSessionsCallbackProxy
function UFindSessionsCallbackProxy:FindSessions(WorldContextObject, PlayerController, MaxResults, bUseLAN, bUseLobbies) end
...
---@field bOnlineServicesCompatibilityEnabled boolean
---@field OnlineServicesCompatibilityInterface UOnlineEngineInterface
...
---@field Logins TArray<FOnlineAccountStoredCredentials>
