...
---@class AJemusi_Tanker_C : AMTVehicleBaseBP_C
...
---@field PumpDoor_R UMTVehicleDoorComponent
---@field PumpDoor_L UMTVehicleDoorComponent
---@field Tanker UStaticMeshComponent
