...
---@class ALoboVan_C : AMTVehicleBaseBP_C
---@field Sidegate_R UMTVehicleDoorComponent
---@field Sidegate_L UMTVehicleDoorComponent
---@field Frontgate_Left UMTVehicleDoorComponent
---@field Frontgate_Right UMTVehicleDoorComponent
---@field Wheel4 UMHWheelComponent
---@field Wheel5 UMHWheelComponent
---@field Tailgate_Right UMTVehicleDoorComponent
---@field Tailgate_Left UMTVehicleDoorComponent
