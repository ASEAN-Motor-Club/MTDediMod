...
---@class ADabo_C : AMTVehicleBaseBP_C
---@field Cargobedwall_L UMTVehicleDoorComponent
---@field Cargobedwall_R UMTVehicleDoorComponent
...
---@field TailGate UMTVehicleDoorComponent
