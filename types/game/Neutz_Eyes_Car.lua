...
---@class ANeutz_Eyes_Car_C : AActor
...
local ANeutz_Eyes_Car_C = {}

---@param DeltaSeconds float
function ANeutz_Eyes_Car_C:ReceiveTick(DeltaSeconds) end
---@param EntryPoint int32
function ANeutz_Eyes_Car_C:ExecuteUbergraph_Neutz_Eyes_Car(EntryPoint) end
