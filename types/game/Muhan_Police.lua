...
---@class AMuhan_Police_C : AMTVehicleBaseBP_C
...
---@field DiffernetialC UMTDifferentialComponent
---@field DifferentialR UMTDifferentialComponent
...
---@field DifferentialF UMTDifferentialComponent
---@field transmission UMHTransmissionComponent
local AMuhan_Police_C = {}
