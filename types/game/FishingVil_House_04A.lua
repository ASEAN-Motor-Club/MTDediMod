...
---@class AFishingVil_House_04A_C : AMTBuilding
...
---@field SM_HouseStairs_02 UStaticMeshComponent
...
local AFishingVil_House_04A_C = {}

function AFishingVil_House_04A_C:TurnMaterial() end
AFishingVil_House_04A_C['Fishing Vil House'] = function(self, ) end
function AFishingVil_House_04A_C:UserConstructionScript() end
---@param DeltaSeconds float
function AFishingVil_House_04A_C:ReceiveTick(DeltaSeconds) end
---@param EntryPoint int32
function AFishingVil_House_04A_C:ExecuteUbergraph_FishingVil_House_04A(EntryPoint) end
