...
---@class ABP_TownHouse_03_C : AStaticMeshActor
...
local ABP_TownHouse_03_C = {}

function ABP_TownHouse_03_C:TurnMaterial() end
ABP_TownHouse_03_C['Town House'] = function(self, ) end
function ABP_TownHouse_03_C:UserConstructionScript() end
---@param DeltaSeconds float
function ABP_TownHouse_03_C:ReceiveTick(DeltaSeconds) end
---@param EntryPoint int32
function ABP_TownHouse_03_C:ExecuteUbergraph_BP_TownHouse_03(EntryPoint) end
