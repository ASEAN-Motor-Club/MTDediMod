---@enum EBuiltInDoubleCameraVariable
local EBuiltInDoubleCameraVariable = {
    None = 0,
    Yaw = 1,
    Pitch = 2,
    Roll = 3,
...
---@enum EBuiltInRotator3dCameraVariable
local EBuiltInRotator3dCameraVariable = {
    None = 0,
    ControlRotation = 1,
    EBuiltInRotator3dCameraVariable_MAX = 2,
}

---@enum EBuiltInVector2dCameraVariable
local EBuiltInVector2dCameraVariable = {
    None = 0,
    YawPitch = 1,
...
local ECameraAutoRotateDirection = {
    Facing = 0,
    Movement = 1,
...
local ECameraNodeOriginPosition = {
    CameraPose = 0,
    ActiveContext = 1,
    OwningContext = 2,
    Pivot = 3,
...
local ECameraRigInitialOrientation = {
    None = 0,
    ContextYawPitch = 1,
    PreviousYawPitch = 2,
...
local ECollisionSafePositionOffsetSpace = {
    ActiveContext = 0,
    OwningContext = 1,
    Pivot = 2,
    CameraPose = 3,
