...
---@field Net_AccessSettings FMTBuildingAccessSettings
local AMTBuilding = {}
...
function AMTBuilding:MulticastSetLocation(NewLocation, NewRotation) end
...
---@field CustomStrapMesh UStaticMesh
...
---@field Net_CustomizationParts FMTCharacterCustomizationParts
---@field Net_EquipmentInventory FMTEquipmentInventory
...
---@field PartVisibilityInVehiclePolicies TMap<EMTCharacterPartSlot, EMTCharacterPartVisibilityInVehiclePolicy>
...
---@field EmoteMontage UAnimMontage
---@field Net_bSprint boolean
local AMTCharacter = {}

function AMTCharacter:ServerStopEmoteMontage() end
---@param Flags uint32
...
function AMTCharacter:OnRep_EquipmentInventory() end
function AMTCharacter:OnRep_CustomizationParts() end
...
function AMTCharacter:MulticastStopEmoteMontage(AnimMontage) end
...
---@param AnimMontage UAnimMontage
---@param bCancelByMove boolean
---@param bLoop boolean
function AMTCharacter:MulticastPlayEmoteMontage(AnimMontage, bCancelByMove, bLoop) end
---@param AnimMontage UAnimMontage
...
function AMTCharacter:HandleEmoteMontageEnded(Montage, bInterrupted) end
...
---@field Net_InfoDataSyncer UMTDataSyncerComponent
---@field Net_Depots TArray<FMTCompanyDepot>
---@field Server_PCsToSync TArray<AMotorTownPlayerController>
...
---@field DeliveryPointFlags uint32
...
---@field DefaultDemandConfigs TArray<FMTDeliveryDemandConfig>
...
---@field ZoneVolume AMTAreaVolume
---@field Net_DemandConfigsOverride TArray<FMTDeliveryDemandConfig>
---@field Net_bNetHasDemandConfigsOverride boolean
---@field Net_StorageConfigMaxStorageOverrides TArray<int32>
...
---@field Net_ProductionStatuses TArray<FMTProductionStatus>
...
function AMTDeliveryPoint:OnRep_StorageConfigMaxStorageOverrides() end
function AMTDeliveryPoint:OnRep_Flags() end
function AMTDeliveryPoint:OnRep_DemandConfigsOverride() end
...
---@field DeliveryPointMarkers TMap<FGuid, AMTARMarker>
---@field Net_DeliveryPointSyncer UMTDataSyncerComponent
---@field Net_DeliverySyncer UMTDataSyncerComponent
...
---@class AMTEscortSystem : AInfo
---@field Net_EscortedVehicles TArray<FMTNetEscortedVehicle>
---@field Server_EscortIdCounter uint32
local AMTEscortSystem = {}
...
---@class AMTPassengerSystem : AInfo
---@field TaxiPassengers TArray<UMTPassengerComponent>
---@field AmbulancePassengers TArray<UMTPassengerComponent>
---@field Hitchhikers TArray<UMTPassengerComponent>
---@field Markers TMap<FGuid, AMTARMarker>
---@field Net_PassengerSyncer UMTDataSyncerComponent
local AMTPassengerSystem = {}
...
---@field GameplayTagContainer FGameplayTagContainer
---@field ZoneVolume AMTAreaVolume
---@field DiscoverKey FName
---@field DiscoverRange float
...
---@class AMTTradeSystem : AInfo
---@field Net_Balance double
---@field Net_DailyBalanceDelta double
---@field Net_TodayBalanceDeltaLive double
---@field Net_WeeklyBalanceDelta double
---@field Net_Last7DaysTradeStats TArray<FMTDailyTradeStats>
local AMTTradeSystem = {}

---@param HUD AMTHUD
function AMTTradeSystem:OnHUDDraw(HUD) end
...
---@field CachedAttachedWinches TArray<UMTWinchComponent>
...
---@field AeroPartAttachComponentNames TMap<FName, FName>
---@field AeroPartAttachComponents TMap<FName, USceneComponent>
...
---@field Server_EscortDisplaySnapshot FMTServerEscortDisplaySnapshot
---@field Server_EscortQualifyingCargos TArray<AMTCargo>
---@field Server_PendingEscortDeliveredCargos TArray<FMTPendingEscortDeliveredCargo>
---@field Server_HeavyEscortDeliveredCargoCount uint16
---@field Server_EscortBatchStartQualifyingCargos TArray<FMTPendingEscortDeliveredCargo>
---@field Server_EscortBatchStartDestination FVector
---@field Server_bPendingEscortCompletion boolean
---@field Server_bEscortDumpContinuationActive boolean
---@field Server_EscortDumpContinuationDeadlinePlatformTimeSeconds double
---@field Server_EscortCurrentType uint8
---@field Server_bEscortCurrentTypeValid boolean
---@field Server_EscortDeliveryBatchDepth int32
...
---@field TaxiDriver FMTVehicleAITaxiDriver
...
---@field Net_PassengerSystem AMTPassengerSystem
---@field Net_Physics AMTPhysics
---@field Net_Police AMTPolice
---@field Net_CompanySystem AMTCompanySystem
---@field Net_Bank AMTBank
---@field Net_TradeSystem AMTTradeSystem
---@field Net_EscortSystem AMTEscortSystem
...
---@field Net_HouseDataSyncerComponent UMTDataSyncerComponent
---@field Net_VehicleDataSyncerComponent UMTDataSyncerComponent
...
---@field LC_EscortJob UMTPlayerEscortJobState
---@field LC_EscortMarkers TArray<FMTLocalEscortMarkerState>
...
---@field Server_CustomizationParts FMTCharacterCustomizationParts
---@field Server_EquipmentInventory FMTEquipmentInventory
...
---@field Server_RGWatchActorsBySpectating TSet<AActor>
---@field Server_RGWatchActorsByCargo TSet<AActor>
---@field Server_RGWatchActorsByVehicleCargo TSet<AActor>
---@field Server_RGWatchActorsByTaxiPassenger TSet<AActor>
---@field Server_RGWatchActorsByAmbulancePassenger TSet<AActor>
...
---@param TowRequestComponent UMTTowRequestComponent
---@param Damage float
function AMotorTownPlayerController:ServerTowRequestAccumulateBodyDamage(TowRequestComponent, Damage) end
...
---@param VehicleSyncKey FGuid
function AMotorTownPlayerController:ServerStartSpectatingVehicleBySyncKey(VehicleSyncKey) end
---@param TargetPlayerState AMotorTownPlayerState
...
function AMotorTownPlayerController:ServerSetVehicleTaxiDepot(CompanyGuid, VehicleId, DepotGuid) end
---@param Vehicle AMTVehicle
...
---@param DepotGuid FGuid
---@param TaxiDispatchLevel int32
function AMotorTownPlayerController:ServerSetTaxiDispatchLevel(DepotGuid, TaxiDispatchLevel) end
...
---@param EquipmentInventory FMTEquipmentInventory
function AMotorTownPlayerController:ServerSetEquipmentInventory(EquipmentInventory) end
...
---@param CustomizationParts FMTCharacterCustomizationParts
function AMotorTownPlayerController:ServerSetCustomizationParts(CustomizationParts) end
---@param AbsoluteLocation FVector
...
---@param NewLocation FVector
---@param NewRotation FRotator
function AMotorTownPlayerController:ServerSetBuildingLocation(Building, NewLocation, NewRotation) end
---@param Building AMTBuilding
---@param Inventory FMTItemInventory
function AMotorTownPlayerController:ServerSetBuildingInventory(Building, Inventory) end
---@param Building AMTBuilding
---@param AccessSettings FMTBuildingAccessSettings
function AMotorTownPlayerController:ServerSetBuildingAccessSettings(Building, AccessSettings) end
---@param bAFK boolean
...
---@param InTotalGameDataHash int32
---@param InVehicleAndPartsHash int32
---@param InCargoHash int32
---@param InItemHash int32
---@param InCheatConsoleVariableHash int32
---@param InBalanceTableHash int32
function AMotorTownPlayerController:ServerRespondGameDataHashValidation(RequestID, InTotalGameDataHash, InVehicleAndPartsHash, InCargoHash, InItemHash, InCheatConsoleVariableHash, InBalanceTableHash) end
---@param AbsoluteLocation FVector
...
function AMotorTownPlayerController:ServerRemoveVehicleCargosFromWatch() end
function AMotorTownPlayerController:ServerRemoveTaxiPassengersFromWatch() end
---@param Actor AActor
...
function AMotorTownPlayerController:ServerRemoveCargoDeliveryPointsFromWatch() end
---@param Building AMTBuilding
...
function AMotorTownPlayerController:ServerRemoveAmbulancePassengersFromWatch() end
---@param CargoSpace UMTVehicleCargoSpaceComponent
...
---@param Vehicle AMTVehicle
---@param ItemKey FName
function AMotorTownPlayerController:ServerRefuelWithJerrycan(Vehicle, ItemKey) end
---@param Vehicle AMTVehicle
---@param CargoSpace UMTVehicleCargoSpaceComponent
---@param FuelType EMTFuelType
...
---@param Vehicle AMTVehicle
function AMotorTownPlayerController:ServerRearSeatBuzzer(Vehicle) end
---@param CompanyGuid FGuid
---@param VehicleId int64
...
---@param EmoteKey FName
function AMotorTownPlayerController:ServerPlayEmote(EmoteKey) end
---@param Winch UMTWinchComponent
...
---@param WaterHose UMTWaterHoseComponent
function AMotorTownPlayerController:ServerPickupWaterHoseNozzle(WaterHose) end
---@param ItemActor AActor
...
---@param EscortId uint32
function AMotorTownPlayerController:ServerEscortCancelJob(EscortId) end
---@param EscortId uint32
function AMotorTownPlayerController:ServerEscortAcceptJob(EscortId) end
---@param Vehicle AMTVehicle
...
---@param Location FVector
---@param Rotation FRotator
---@param bHoldingItem boolean
function AMotorTownPlayerController:ServerDropItem(ItemKey, InventorySlotIndex, bOwnItem, Location, Rotation, bHoldingItem) end
...
---@param VehicleSyncKey FGuid
---@param Cost int64
function AMotorTownPlayerController:ServerDespawnVehicleBySyncKey(VehicleSyncKey, Cost) end
---@param Vehicle AMTVehicle
---@param Cost int64
...
function AMotorTownPlayerController:ServerCheat_TradeResetStats() end
function AMotorTownPlayerController:ServerCheat_TradeReset() end
---@param Balance double
function AMotorTownPlayerController:ServerCheat_TradeBalanceAdd(Balance) end
---@param NumResident int32
function AMotorTownPlayerController:ServerCheat_ResidentForceMove(NumResident) end
---@param Hours float
function AMotorTownPlayerController:ServerCheat_PolicyReadinessAdd(Hours) end
function AMotorTownPlayerController:ServerCheat_CompanyAddDummyReportStats() end
...
---@param PolicyKey FName
function AMotorTownPlayerController:ServerCancelTownPolicy(PolicyKey) end
---@param Passenger UMTPassengerComponent
...
---@param PolicyKey FName
function AMotorTownPlayerController:ServerBuyTownPolicy(PolicyKey) end
---@param House AMTHouse
...
---@param Vehicle AMTVehicle
function AMotorTownPlayerController:ServerAddVehicleCargosToWatch(Vehicle) end
function AMotorTownPlayerController:ServerAddTaxiPassengersToWatch() end
---@param Actor AActor
...
function AMotorTownPlayerController:ServerAddCargoDeliveryPointsToWatch() end
---@param Cargo AMTCargo
---@param Damage float
function AMotorTownPlayerController:ServerAddCargoDamage(Cargo, Damage) end
function AMotorTownPlayerController:ServerAddAmbulancePassengersToWatch() end
---@param TargetPlayerState AMotorTownPlayerState
...
---@param TargetSyncer UMTDataSyncerComponent
function AMotorTownPlayerController:Server_RequestMTDataSyncInitial(TargetSyncer) end
---@param TargetSyncer UMTDataSyncerComponent
---@param InSyncGeneration int32
---@param ChunkIndex int32
function AMotorTownPlayerController:Server_AckMTDataSyncInitialChunk(TargetSyncer, InSyncGeneration, ChunkIndex) end
...
---@param NumMovementOwnedVehicles int32
function AMotorTownPlayerController:ClientSpawnDrivingModeVehiclesFinished(NumSpawned, NumMovementOwnedVehicles) end
...
---@param RequestID int32
function AMotorTownPlayerController:ClientRequestGameDataHashValidation(RequestID) end
---@param bSucceeded boolean
---@param Lane AMTDragRaceLane
---@param Vehicle AMTVehicle
...
---@param Vehicle AMTVehicle
function AMotorTownPlayerController:ClientRearSeatBuzzer(Vehicle) end
---@param CompanyGuid FGuid
---@param VehicleId int64
---@param VehicleData FMTPlayerDataVehicle
---@param Parts TArray<FMTPlayerDataVehiclePart>
...
---@param EscortId uint32
function AMotorTownPlayerController:ClientEscortAcceptJobSucceeded(EscortId) end
---@param ItemKey FName
---@param InventorySlotIndex int32
---@param bSuccess boolean
---@param bOwnItem boolean
---@param bHoldingItem boolean
---@param ItemActor AActor
function AMotorTownPlayerController:ClientDropItemResult(ItemKey, InventorySlotIndex, bSuccess, bOwnItem, bHoldingItem, ItemActor) end
...
---@param bSucceeded boolean
function AMotorTownPlayerController:ClientAbandonTowRequestResult(bSucceeded) end
function AMotorTownPlayerController:ClientAbandonDroneResponse() end
---@param TargetSyncer UMTDataSyncerComponent
---@param InSyncGeneration int32
---@param ChunkIndex int32
---@param bIsLastChunk boolean
---@param Packets TArray<FMTDataSyncPacket>
function AMotorTownPlayerController:Client_ReceiveMTDataSyncInitialChunk(TargetSyncer, InSyncGeneration, ChunkIndex, bIsLastChunk, Packets) end
---@param TargetSyncer UMTDataSyncerComponent
---@param InSyncGeneration int32
---@param Packets TArray<FMTDataSyncPacket>
function AMotorTownPlayerController:Client_ReceiveMTDataSyncDeltaChunk_Unreliable(TargetSyncer, InSyncGeneration, Packets) end
---@param TargetSyncer UMTDataSyncerComponent
---@param InSyncGeneration int32
---@param Packets TArray<FMTDataSyncPacket>
function AMotorTownPlayerController:Client_ReceiveMTDataSyncDeltaChunk_Reliable(TargetSyncer, InSyncGeneration, Packets) end
...
function AMotorTownPlayerController:Cheat_TradeResetStats() end
function AMotorTownPlayerController:Cheat_TradeReset() end
---@param Balance double
function AMotorTownPlayerController:Cheat_TradeBalanceAdd(Balance) end
function AMotorTownPlayerController:Cheat_TrackIRInit() end
...
---@param NumResident int32
function AMotorTownPlayerController:Cheat_ResidentForceMove(NumResident) end
...
---@param Hours float
function AMotorTownPlayerController:Cheat_PolicyReadinessAdd(Hours) end
...
function AMotorTownPlayerController:Cheat_CompanyAddDummyReportStats() end
---@param Amount float
...
function AMotorTownPlayerController:Cheat_ClearDiscoveredPOIs() end
...
---@field BasePayment int64
---@field ExportPrice int32
---@field ImportPrice int32
...
---@field VehicleSpawnCostByVehicleType TMap<EMTVehicleType, int32>
---@field VehicleSpawnCostByTruckClass TMap<EMTTruckClass, int32>
---@field VehicleSpawnCostPer1KmByTruckClass TMap<EMTTruckClass, int32>
---@field TireWearByWeightPowerByTruckClass TMap<EMTTruckClass, float>
...
---@field TowStartRewardBasePayment float
---@field TowStartRewardSizeUnit float
---@field TowStartRewardWeightUnit float
---@field TowStartRewardSizeRateClamp FVector2D
---@field TowStartRewardWeightRateClamp FVector2D
---@field TowStartRewardDamageExponent float
---@field TowStartRewardDamageMultiplierRange FVector2D
...
---@class FMTBuildingAccessSettings
---@field InventoryAccess EMTBuildingAccess
local FMTBuildingAccessSettings = {}
...
---@field VisibilityInVehiclePolicy EMTCharacterPartVisibilityInVehiclePolicy
---@field CustomizationSlot EMTCharacterCustomizationSlot
---@field EquipmentSlot EMTEquipmentSlot
...
---@class FMTCharacterCustomizationParts
---@field Slots TArray<FMTCharacterCustomizationSlotEntry>
local FMTCharacterCustomizationParts = {}



---@class FMTCharacterCustomizationSlotEntry
---@field Slot EMTCharacterCustomizationSlot
---@field PartKey FName
local FMTCharacterCustomizationSlotEntry = {}
...
---@field DailyStats TArray<FMTCompanyStat>
...
---@field TaxiProfitShareToApply int64
...
---@field BuildingRunningCostMultiplier float
---@field RunningCostBasePer10Mins int32
---@field RunningCostTaxiDispatchPer10Mins int32
---@field RunningCostPer10Mins int32
---@field StorageMultiplier float
---@field TaxiDispatchLevel int32
---@field TaxiDispatchRadius float
---@field DailyStats TArray<FMTCompanyDepotStat>
...
---@class FMTCompanyDepotStat
---@field BuildingGuid FGuid
---@field TotalCost double
---@field NumDispatched int32
---@field NumPickuped int32
---@field NumPickupedPassengers int32
local FMTCompanyDepotStat = {}
...
---@field TaxiAIState EMTVehicleAITaxiDriverState
...
---@class FMTCompanyVehiclePassengerStat
---@field NumPassengers int32
---@field Payments float
local FMTCompanyVehiclePassengerStat = {}
...
---@field TaxiDepotHouseGuid FGuid
...
---@field TotalCost int64
---@field TotalIncome int64
---@field PassengerStat FMTCompanyVehiclePassengerStat
...
---@class FMTCompositeInventorySlotInfo
---@field Accessor UMTItemInventoryAccessor
---@field SlotIndex int32
---@field ItemKey FName
---@field NumStack int32
local FMTCompositeInventorySlotInfo = {}
...
---@class FMTDailyTradeStats
---@field ExportCount int32
---@field ExportAmount double
---@field ExportCargoCounts TArray<FMTTradeCargoKeyCount>
---@field ImportCount int32
---@field ImportAmount double
---@field ImportCargoCounts TArray<FMTTradeCargoKeyCount>
---@field BalanceDelta_Policy double
---@field BalanceDelta_Etc double
---@field BalanceDeltaTotal double
local FMTDailyTradeStats = {}
...
---@class FMTDataSyncClientState
local FMTDataSyncClientState = {}


---@class FMTDataSyncPacket
---@field Key FGuid
---@field Op EMTDataSyncOp
---@field StructPath FName
---@field Payload TArray<uint8>
local FMTDataSyncPacket = {}



---@class FMTDataSyncer
---@field Items TMap<FGuid, FInstancedStruct>
---@field Keys TArray<FGuid>
local FMTDataSyncer = {}
...
---@field HostWebAPIOptions TArray<FMTWebApiOptions>
---@field GameDataValidation FMTGameDataValidationConfig
local FMTDediConfig = {}
...
---@field PathGradeWeightedDistance float
...
---@field FloatParams1 TArray<float>
...
---@class FMTDiscoverRow : FTableRowBase
---@field CounterType EMTPlayerCounterType
---@field DiscoverMessage FText
local FMTDiscoverRow = {}
...
---@class FMTEmoteRow : FTableRowBase
---@field EmoteNameTexts FMTTextByTexts
---@field Command FString
---@field AnimMontage UAnimMontage
---@field bCancelByMove boolean
---@field bLoop boolean
local FMTEmoteRow = {}
...
---@class FMTEngineSoundRPMSource
---@field RPM float
---@field EngineSound USoundBase
---@field ExhaustSound USoundBase
local FMTEngineSoundRPMSource = {}



---@class FMTEquipmentInventory
---@field EquipmentSlots TArray<FMTEquipmentInventorySlot>
local FMTEquipmentInventory = {}



---@class FMTEquipmentInventorySlot
---@field Slot EMTEquipmentSlot
---@field ItemKey FName
local FMTEquipmentInventorySlot = {}



---@class FMTEscortingPlayer
---@field PlayerState APlayerState
---@field Server_AcceptPlatformTimeSeconds double
---@field Net_InvalidReason EMTEscortInvalidReason
---@field Net_InvalidStateRemainingSeconds uint16
---@field Net_DistRatioPct uint8
---@field Net_RewardRatioPct uint8
local FMTEscortingPlayer = {}
...
---@class FMTGameDataValidationConfig
---@field bAllowVehicleAndPartsMismatch boolean
---@field bAllowCargoMismatch boolean
---@field bAllowItemMismatch boolean
---@field bAllowConsoleVariableMismatch boolean
---@field bAllowBalanceTableMismatch boolean
local FMTGameDataValidationConfig = {}
...
---@field ActivePolicies TArray<FName>
---@field PolicyReadinessHours TArray<float>
...
---@class FMTHitchhikerPickupCooldown
local FMTHitchhikerPickupCooldown = {}
...
---@field AttachmentScaleMin float
---@field AttachmentScaleMax float
---@field PickupSound USoundBase
---@field StaticMesh UStaticMesh
...
---@class FMTLocalEscortMarkerState
---@field PlayerState APlayerState
---@field AttachedPawn APawn
---@field Marker AMTARMarker
local FMTLocalEscortMarkerState = {}
...
---@field bAllowTeleport boolean
---@field MergeDistance float
---@field MaxMergeWorldDistance float
---@field ActorClass TSubclassOf<AActor>
---@field GameplayTagQueryStatic FGameplayTagQuery
---@field GameplayTagQuery FGameplayTagQuery
...
---@field ColorIndex int8
---@field Weight float
---@field SenderPointGuid FGuid
---@field ReceiverPointGuid FGuid
---@field RegisteredTimeSeconds float
---@field ExpiresAtServerTimeSeconds double
---@field PaymentMultiplierByDemand float
---@field PaymentMultiplierBySupply float
...
---@field PathGradeWeightedDistance float
---@field PathSpeedKPH float
local FMTNetDelivery = {}



---@class FMTNetDeliveryPoint
---@field DeliveryPointGuid FGuid
---@field NameNamespace FString
---@field NameKey FString
---@field Location FVector
---@field NumDeliveries int32
---@field RuntimeFlags uint32
---@field bHasProductionWithOutput boolean
---@field DeliveryPointType EDeliveryMissionPointType
---@field TooltipDemandCargos TArray<FMTNetTooltipCargoSpec>
---@field TooltipSupplyCargos TArray<FMTNetTooltipCargoSpec>
---@field TooltipSupplyCargoSpaceTypes TArray<EMTCargoSpaceType>
local FMTNetDeliveryPoint = {}
...
---@class FMTNetEscortedVehicle
---@field Vehicle AMTVehicle
---@field VehicleUniqueId uint32
---@field EscortId uint32
---@field Destination FVector
---@field EscortingPlayers TArray<FMTEscortingPlayer>
---@field DriverName FString
---@field VehicleName FString
---@field CargoName FString
---@field GrossWeightKg float
---@field EscortType EMTEscortType
---@field DeliveryPayment int64
---@field RewardBaseMoney int64
---@field Net_bRouteStarted boolean
---@field Net_TotalRouteCm double
---@field QualifyingCargoCount uint16
---@field DeliveredCargoCount uint16
---@field bDestinationRepresentsCluster boolean
---@field bHasMultipleDestinations boolean
local FMTNetEscortedVehicle = {}
...
---@field bOwned boolean
---@field Size FVector
local FMTNetHouse = {}



---@class FMTNetPassenger
---@field Location FVector
---@field PassengerType EMTPassengerType
---@field PassengerFlags int32
---@field bArrived boolean
---@field bSeated boolean
---@field ResidentId int32
---@field NumGroupCharacters int32
---@field SearchAndRescueRadiusRatio float
---@field ReservedPlayerId int32
local FMTNetPassenger = {}
...
---@class FMTNetTooltipCargoSpec
---@field CargoKey FName
---@field CargoType EDeliveryCargoType
local FMTNetTooltipCargoSpec = {}
...
---@field VehicleFlags uint32
---@field NetFlags uint8
---@field AbandonedTimeSeconds float
---@field VehicleName FName
---@field AccountNickname FName
---@field LastDriverName FName
local FMTNetVehicle = {}
...
---@class FMTPendingEscortDeliveredCargo
---@field Cargo TWeakObjectPtr<AMTCargo>
---@field CargoUniqueId uint32
---@field DeliveredDestination FVector
---@field bWasEmptyContainer boolean
---@field bWasDumpUnload boolean
local FMTPendingEscortDeliveredCargo = {}
...
---@class FMTPlayerDataCompanyDepotStat
---@field BuildingGuid FGuid
---@field TotalCost double
---@field NumDispatched int32
---@field NumPickuped int32
---@field NumPickupedPassengers int32
local FMTPlayerDataCompanyDepotStat = {}
...
---@field Materials TMap<FName, int32>
---@field ItemInventory FMTItemInventory
---@field AccessSettings FMTBuildingAccessSettings
...
---@field Storage float
---@field TaxiDispatchLevel int32
---@field DailyStats TArray<FMTPlayerDataCompanyDepotStat>
...
---@field ProductionSpeedMultiplierZoneCoeffs TArray<EMTZoneCoeffType>
...
---@class FMTProductionStatus
---@field Progress float
---@field ProductionSpeedMultiplier float
---@field ProductionFlags uint32
local FMTProductionStatus = {}
...
---@field RelevantActors TSet<AActor>
...
---@class FMTResolvedParts
---@field Parts TMap<EMTCharacterPartSlot, FName>
local FMTResolvedParts = {}
...
---@field RightSideClearance float
...
---@class FMTSaveGameBuildingAccessSettings
---@field InventoryAccess FString
local FMTSaveGameBuildingAccessSettings = {}



---@class FMTSaveGameCharacterCustomizationParts
---@field Slots TArray<FMTSaveGameCharacterCustomizationSlot>
local FMTSaveGameCharacterCustomizationParts = {}



---@class FMTSaveGameCharacterCustomizationSlot
---@field Slot EMTCharacterCustomizationSlot
---@field PartKey FName
local FMTSaveGameCharacterCustomizationSlot = {}
...
---@field DailyStats TArray<FMTSaveGameCompanyStat>
...
---@class FMTSaveGameCompanyDepotStat
---@field BuildingGuid FGuid
---@field TotalCost double
---@field NumDispatched int32
---@field NumPickuped int32
---@field NumPickupedPassengers int32
local FMTSaveGameCompanyDepotStat = {}
...
---@class FMTSaveGameCompanyStat
---@field TotalCost int64
---@field TotalIncome int64
local FMTSaveGameCompanyStat = {}
...
---@field RoutePointIndex int32
---@field VehicleFlags uint32
---@field DailyStats TArray<FMTSaveGameCompanyVehicleStat>
local FMTSaveGameCompanyVehicle = {}



---@class FMTSaveGameCompanyVehicleCargoStat
---@field CargoKey FName
---@field Payments float
---@field NumCargo int32
---@field Weights float
local FMTSaveGameCompanyVehicleCargoStat = {}



---@class FMTSaveGameCompanyVehiclePassengerStat
---@field NumPassengers int32
---@field Payments float
local FMTSaveGameCompanyVehiclePassengerStat = {}



---@class FMTSaveGameCompanyVehicleStat
---@field TotalCost int64
---@field TotalIncome int64
---@field PassengerStat FMTSaveGameCompanyVehiclePassengerStat
---@field CargoStats TArray<FMTSaveGameCompanyVehicleCargoStat>
local FMTSaveGameCompanyVehicleStat = {}
...
---@class FMTSaveGameDailyTradeStats
---@field ExportCount int32
---@field ExportAmount double
---@field ExportCargoCounts TArray<FMTSaveGameTradeCargoKeyCount>
---@field ImportCount int32
---@field ImportAmount double
---@field ImportCargoCounts TArray<FMTSaveGameTradeCargoKeyCount>
---@field BalanceDelta_Policy double
---@field BalanceDelta_Etc double
---@field BalanceDeltaTotal double
local FMTSaveGameDailyTradeStats = {}



---@class FMTSaveGameEquipmentInventory
---@field EquipmentSlots TArray<FMTSaveGameEquipmentInventorySlot>
local FMTSaveGameEquipmentInventory = {}



---@class FMTSaveGameEquipmentInventorySlot
---@field Slot EMTCharacterPartSlot
---@field ItemKey FName
local FMTSaveGameEquipmentInventorySlot = {}
...
---@field EquipmentInventory FMTSaveGameEquipmentInventory
---@field CharacterCustomizationParts FMTSaveGameCharacterCustomizationParts
...
---@field DiscoveredPOIGuids TArray<FString>
...
---@class FMTSaveGameTradeCargoKeyCount
---@field CargoKey FName
---@field Count int32
local FMTSaveGameTradeCargoKeyCount = {}
...
---@field Trade FMTSaveGameWorldTrade
...
---@field Materials TMap<FName, int32>
---@field ItemInventory FMTSaveGameItemInventory
---@field AccessSettings FMTSaveGameBuildingAccessSettings
...
---@class FMTSaveGameWorldPolicy
---@field ActivePolicies TArray<FName>
---@field PolicyReadinessHours TArray<float>
local FMTSaveGameWorldPolicy = {}
...
---@field Policy FMTSaveGameWorldPolicy
local FMTSaveGameWorldTownState = {}



---@class FMTSaveGameWorldTrade
---@field Balance double
---@field Last7DaysStats TArray<FMTSaveGameDailyTradeStats>
local FMTSaveGameWorldTrade = {}
...
---@field Storage float
---@field TaxiDispatchLevel int32
---@field DailyStats TArray<FMTSaveGameCompanyDepotStat>
...
---@class FMTServerEscortDisplaySnapshot
---@field CargoUniqueId uint32
---@field bWasEmptyContainer boolean
---@field CargoName FString
---@field Destination FVector
---@field DeliveryPayment int64
local FMTServerEscortDisplaySnapshot = {}
...
---@class FMTTownPolicy : FTableRowBase
---@field PolicyName FText
---@field TradeCostPerHour int32
---@field PrepHours float
---@field PolicyEffects TMap<EMTTownPolicyEffectType, float>
local FMTTownPolicy = {}



---@class FMTTradeCargoKeyCount
---@field CargoKey FName
---@field Count int32
local FMTTradeCargoKeyCount = {}
...
---@class FMTVehicleAITaxiDriver
---@field CompanyOwnerPC AMotorTownPlayerController
---@field DepotActor AActor
---@field BuildingGuid FGuid
---@field PassengerToPickup UMTPassengerComponent
local FMTVehicleAITaxiDriver = {}
...
---@field DisplayName FText
---@field DisplayName2 FMTTextByTexts
...
---@field QuadWheelMesh UStaticMesh
...
---@class FMTWebApiOptions
---@field Endpoint FString
---@field Params TMap<FString, FString>
local FMTWebApiOptions = {}
...
---@class FMTZoneRow : FTableRowBase
---@field Coeffs TMap<EMTZoneCoeffType, float>
local FMTZoneRow = {}
...
---@class UActiveTownPolicyEntryWidget : UMTListViewEntryWidget
---@field PolicyTextBlock URichTextBlock
---@field CancelButton UMTButtonWidget
local UActiveTownPolicyEntryWidget = {}
...
---@field CachedVehicleSyncKeys TArray<FGuid>
---@field SelectedVehicleSyncKey FGuid
---@field SelectedNetVehicle FMTNetVehicle
...
---@field ScalePanel UPanelWidget
---@field ScaleSetting USettingWidget
...
---@field InventoryAccess USettingWidget
...
---@class UBuildingPlacementWidget : UUserWidget
---@field TransformWidget UMTTransformWidget
---@field SaveButton UMTButtonWidget
---@field ControlsPanel UPanelWidget
---@field Building AMTBuilding
---@field PreviewBuilding AMTBuilding
---@field Camera ACameraActor
local UBuildingPlacementWidget = {}
...
---@field HelpTextOverlay UWidget
---@field HelpTextBlock URichTextBlock
---@field ButtonHelpTexts TArray<FText>
...
---@field StorageProgressBarWidget UProgressWiget
---@field EditNameButton UMTButtonWidget
---@field RestockButton UMTButtonWidget
---@field TaxiDispatchLevel USettingWidget
---@field ReportTextBlock URichTextBlock
...
---@class UCompanyGraphWidget : UUserWidget
---@field CartesianPlot UCartesianPlot
---@field DataSource_DailyStats UMTCompanyDailyStatsDataSource
local UCompanyGraphWidget = {}
...
---@field SortButton_Date UMTButtonWidget
---@field SortButton_PlayerCount UMTButtonWidget
...
---@field HistoryGraphWidget UCompanyGraphWidget
...
---@field ConditionProgressBarWidget UProgressWiget
...
---@field RemoveRouteButton UMTButtonWidget
...
---@field AssignTaxiDepotButton UMTButtonWidget
---@field RemoveTaxiDepotButton UMTButtonWidget
...
---@field PassengersWidget UPassengersWidget
...
---@field VehiclesListView UMTListView
---@field SearchBoxWidget UStringSearchBoxWidget
---@field AddButton UMTButtonWidget
---@field AddSlotButton UMTButtonWidget
---@field CategoryFilterCheckBox_Bus UCheckBoxWidget
---@field CategoryFilterCheckBox_Truck UCheckBoxWidget
---@field CategoryFilterCheckBox_Taxi UCheckBoxWidget
---@field CategoryFilterCheckBox_Etc UCheckBoxWidget
...
---@class UDailyTradeStatsEntryWidget : UUserWidget
---@field DayTitleText UTextBlock
---@field TotalValueText UTextBlock
---@field ExportValueText UTextBlock
---@field ImportValueText UTextBlock
---@field PolicyValueText UTextBlock
---@field EtcValueText UTextBlock
---@field ExportCargoText UTextBlock
---@field ImportCargoText UTextBlock
local UDailyTradeStatsEntryWidget = {}
...
---@field ToggleAIWidget UControlWidget
---@field CruiseControlWidget UControlWidget
...
---@class UEscortEntryWidget : UMTListViewEntryWidget
---@field NameWidget URichTextBlock
---@field DistanceToDestinationWidget URichTextBlock
---@field DetailsWidget URichTextBlock
---@field MoneyWidget UMTMoneyWidget
---@field AcceptButton UMTButtonWidget
---@field AssignedWidget UWidget
local UEscortEntryWidget = {}



---@class UEscortListWidget : UUserWidget
---@field EscortListView UMTListView
---@field CachedListObjects TArray<UMTEscortListObject>
local UEscortListWidget = {}
...
---@field EscortStatus UJobStatusEntryWidget
...
---@field HeaderMultiplierButton UMTButtonWidget
---@field HeaderCargoButton UMTButtonWidget
---@field HeaderSenderButton UMTButtonWidget
---@field HeaderDistanceButton UMTButtonWidget
---@field HeaderPayButton UMTButtonWidget
...
---@field EngineSoundData UMTEngineSoundDataAsset
...
---@field BeginnerHitchhikers TArray<AMTCharacter>
...
---@class UMTActiveTownPolicyListObject : UObject
local UMTActiveTownPolicyListObject = {}
...
---@field VehicleSyncKey FGuid
---@field NetVehicle FMTNetVehicle
...
---@class UMTBalanceSettings : UDeveloperSettings
---@field BalanceTable FMTBalanceTable
local UMTBalanceSettings = {}
...
---@class UMTCompanyDailyStatsDataSource : UObject
---@field DailyStats TArray<FMTCompanyStat>
---@field IncomePoints TArray<FKantanCartesianDatapoint>
---@field CostPoints TArray<FKantanCartesianDatapoint>
local UMTCompanyDailyStatsDataSource = {}
...
---@class UMTCompositeInventoryDragDrop : UDragDropOperation
---@field DragSourceWidget UMTCompositeInventorySlotWidget
---@field NumStack int32
local UMTCompositeInventoryDragDrop = {}



---@class UMTCompositeInventorySlotWidget : UUserWidget
---@field DragWidgetClass TSubclassOf<UItemWidget>
---@field Overlay UOverlay
---@field ItemWidget UItemWidget
---@field HoldingHighlight UBorder
---@field SlotTypeText UTextBlock
---@field SlotInfo FMTCompositeInventorySlotInfo
local UMTCompositeInventorySlotWidget = {}



---@class UMTCompositeInventoryWidget : UUserWidget
---@field PreviewImageWidget UImage
---@field SlotWidgetClass TSubclassOf<UMTCompositeInventorySlotWidget>
---@field ItemInventoryWrapBox UWrapBox
---@field EquipmentInventoryWrapBox UWrapBox
---@field CouponListWidget UCouponListWidget
---@field ItemSlotWidgets TArray<UMTCompositeInventorySlotWidget>
---@field EquipmentSlotWidgets TArray<UMTCompositeInventorySlotWidget>
---@field ItemInventoryAccessor UMTItemInventoryAccessor
---@field EquipmentInventoryAccessor UMTItemInventoryAccessor
---@field ActorPreview AMTActorPreview
---@field PreviewCharacter AMTCharacter
local UMTCompositeInventoryWidget = {}
...
---@field ReverseViewMaterial UMaterialInterface
...
---@field ReverseViewMID UMaterialInstanceDynamic
---@field ReverseViewMaterialIndex int32
---@field ReverseViewPrevMaterial UMaterialInterface
local UMTDashboard = {}



---@class UMTDataSyncerComponent : UActorComponent
---@field SyncGeneration int32
local UMTDataSyncerComponent = {}

function UMTDataSyncerComponent:RequestInitialSync() end
function UMTDataSyncerComponent:OnRep_SyncGeneration() end
---@return boolean
function UMTDataSyncerComponent:ClientHasCompletedInitialSync() end


---@class UMTDecalBaker : UObject
---@field BoundDilateMaterial UMaterialInstanceDynamic
---@field BoundsActor AStaticMeshActor
---@field ScratchCaptureComponent USceneCaptureComponent2D
---@field ScratchUndilatedRT UTextureRenderTarget2D
...
---@param GameResourceObject UObject
function UMTEditorBlueprintLibrary:MigrateVehicleCargoSpaceFromGameResource(GameResourceObject) end
---@param VehicleTable UDataTable
function UMTEditorBlueprintLibrary:MigrateVehicleCargoSpace(VehicleTable) end
...
---@param VehiclesTable UDataTable
---@param GameResourceObject UObject
function UMTEditorBlueprintLibrary:FillWheelPartsToVehicleTable(VehiclesTable, GameResourceObject) end
---@param PCG UPCGComponent
...
---@param Objects TArray<UObject>
---@param IconTexture UTexture2D
---@param DefaultHoldingRotation FRotator
---@param AttachmentRotationStep FRotator
function UMTEditorBlueprintLibrary:AddAttachmentsToItemsTable(ItemsTable, Objects, IconTexture, DefaultHoldingRotation, AttachmentRotationStep) end


---@class UMTEngineComponent : USceneComponent
---@field EngineData UMHEngineDataAsset
---@field AudioComponent UAudioComponent
---@field EngineSoundComponent UMTEngineSoundComponent
...
---@class UMTEngineSoundComponent : USceneComponent
---@field EngineSoundData UMTEngineSoundDataAsset
---@field StarterMotorAudioComponent UAudioComponent
---@field EngineSounds TArray<FMTRpmSound>
---@field ExhaustSounds TArray<FMTRpmSound>
---@field EngineAudioComponents TArray<UAudioComponent>
---@field ExhaustAudioComponents TArray<UAudioComponent>
local UMTEngineSoundComponent = {}



---@class UMTEngineSoundDataAsset : UDataAsset
---@field RPMSources TArray<FMTEngineSoundRPMSource>
---@field CrossfadeRPMRange float
---@field MasterVolume float
---@field EngineVolumeMultiplier float
---@field ExhaustVolumeMultiplier float
---@field MinPitch float
---@field MaxPitch float
---@field IdleEngineRatio float
---@field IdleExhaustRatio float
---@field StarterMotorSound USoundBase
local UMTEngineSoundDataAsset = {}
...
---@class UMTEscortListObject : UObject
---@field EscortId uint32
local UMTEscortListObject = {}
...
---@class UMTExportAllDataTablesCommandlet : UCommandlet
local UMTExportAllDataTablesCommandlet = {}
...
---@field RainSoundClass USoundClass
...
---@field EscortMarkerActorClass TSubclassOf<AMTARMarker>
...
---@field Zones UDataTable
---@field TownPolicies UDataTable
---@field Discovers UDataTable
...
---@field Server_PickupLockedPC APlayerController
---@field Server_ConsumeLockedPC APlayerController
---@field Server_OwnerCharacterGuid FGuid
---@field Net_OwnerName FString
---@field Net_ItemRuntimeFlags uint32
...
---@field SceneCaptureComponent USceneCaptureComponent2D
---@field Materials TArray<UMaterialInstanceDynamic>
---@field bOverrideDigitalScreenSocketLocationInActorSpace boolean
---@field DigitalScreenSocketLocationInActorSpace FVector
...
---@field Server_ReservedAICon AMTVehicleAIController
...
---@class UMTPassengerListObject : UObject
---@field Character AMTCharacter
---@field Passenger UMTPassengerComponent
local UMTPassengerListObject = {}
...
---@class UMTPlayerEquipmentInventoryAccessor : UMTItemInventoryAccessor
local UMTPlayerEquipmentInventoryAccessor = {}


---@class UMTPlayerEscortJobState : UObject
---@field EscortId uint32
local UMTPlayerEscortJobState = {}
...
---@field CameraPitchRotationLagSpeed float
...
---@class UMTTransformStepWidget : UUserWidget
---@field StepSetting USettingWidget
---@field AxisSetting0 USettingWidget
---@field AxisSetting1 USettingWidget
---@field AxisSetting2 USettingWidget
---@field bShowStep boolean
local UMTTransformStepWidget = {}

---@param InText FText
function UMTTransformStepWidget:SetTitleText(InText) end


---@class UMTTransformWidget : UUserWidget
---@field LocationGroup UMTTransformStepWidget
---@field RotationGroup UMTTransformStepWidget
---@field ScalePanel UPanelWidget
---@field ScaleStepSetting USettingWidget
---@field ScaleValueSetting USettingWidget
---@field bShowLocation boolean
---@field bShowRotation boolean
---@field bShowScale boolean
---@field bShowLocationStep boolean
---@field bShowRotationStep boolean
---@field bShowScaleStep boolean
local UMTTransformWidget = {}
...
---@class UMTUIColorPalette : UDataAsset
---@field DefaultIconColor FLinearColor
---@field JobIconColor FLinearColor
---@field DroppedCargoIconColor FLinearColor
---@field TradeIconColor FLinearColor
---@field DeliveryIconColor FLinearColor
---@field CompanyIconColor FLinearColor
---@field PoliceIconColor FLinearColor
---@field WreckerIconColor FLinearColor
---@field DestinationIconColor FLinearColor
---@field BackgroundColor FLinearColor
---@field ButtonBackgroundColor FLinearColor
---@field ButtonCheckedBackgroundColor FLinearColor
---@field TitleBGColor FLinearColor
---@field TextColor FLinearColor
---@field FocusTextColor FLinearColor
---@field HighlightTextColor FLinearColor
---@field TableHeaderTextColor FLinearColor
---@field ButtonTextColor FLinearColor
---@field TitleTextColor FLinearColor
---@field PopupTitleTextColor FLinearColor
---@field HighlightColor FLinearColor
---@field HoveredColor FLinearColor
local UMTUIColorPalette = {}



---@class UMTUISettings : UDeveloperSettings
...
---@field DriveModeSettingWidgetClass TSubclassOf<UDriveModeSettingWidget>
...
---@field VehiclePartInventoryInteractionWidgetClass TSubclassOf<UVehiclePartInvenotryInteractionWidget>
...
---@field CompanyVehicleControlPanelWidgetClass TSubclassOf<UCompanyVehicleControlPanelWidget>
...
---@field CompanyVehicleWidgetClass TSubclassOf<UCompanyVehicleWidget>
---@field CompanyDepotWidgetClass TSubclassOf<UCompanyDepotWidget>
...
---@field BuildingPlacementWidgetClass TSubclassOf<UBuildingPlacementWidget>
...
---@field OtherPlayersHouseIconWidgetClass TSubclassOf<UUserWidget>
...
---@field CompanyTaxiIconWidgetClass TSubclassOf<UUserWidget>
---@field CompanyDepotIconWidgetClass TSubclassOf<UUserWidget>
---@field CompanyVehicleDestinationIconWidgetClass TSubclassOf<UUserWidget>
...
---@field LevelProgressWidgetClass TSubclassOf<ULevelProgressWidget>
---@field LevelWidgetClass TSubclassOf<ULevelWidget>
...
---@param bSucceeded boolean
function UMTVehicleBusComponent:ClientEnterPassengerCharacterResponse(bSucceeded) end
...
---@field CustomControls TArray<FMTControlPanelControl>
...
---@field bSlidingInHingeSocketRelative boolean
...
---@class UMTWaterHoseComponent : UStaticMeshComponent
---@field MaxHoseLength float
---@field HostStartSocketName FName
---@field InteractableComponent UMTInteractableComponent
---@field CableComponent UCableComponent
---@field HoseMaterial UMaterialInterface
---@field NozzleHoseEndSocketName FName
---@field Net_HoseNozzleActor AActor
local UMTWaterHoseComponent = {}

function UMTWaterHoseComponent:ServerBreakHose() end
function UMTWaterHoseComponent:OnRep_HoseNozzleActor() end


---@class UMTWaterSprayComponent : USceneComponent
---@field bOneTimeOnly boolean
---@field OneTimeDurationSeconds float
...
---@field CachedOwnerVehicle AMTVehicle
...
---@field CachedAttachedVehicle AMTVehicle
...
---@class UPassengerWidget : UMTListViewEntryWidget
---@field NameTextBlock URichTextBlock
---@field DestinationTextBlock URichTextBlock
---@field DistanceTextBlock UTextBlock
---@field LeaveButton UMTButtonWidget
---@field Character AMTCharacter
---@field Passenger UMTPassengerComponent
...
---@class UProductionItemWidget : UMTListViewEntryWidget
...
---@field ServerInfoText URichTextBlock
...
---@field TabButton7 UMTButtonWidget
...
---@field TownPolicyButton UMTButtonWidget
---@field TradeStatsButton UMTButtonWidget
---@field TradeStatWidgetClass TSubclassOf<UTradeStatWidget>
---@field ActiveTownPolicyListView UMTListView
---@field CachedActivePolicyKeys TArray<FName>
...
---@class UTradeStatWidget : UUserWidget
---@field DailyTradeStatsWrapBox UWrapBox
---@field EntryWidgets TArray<UDailyTradeStatsEntryWidget>
local UTradeStatWidget = {}
...
---@field ZoomInButton UMTButtonWidget
---@field ZoomOutButton UMTButtonWidget
...
---@field ZoomInKeyWidget UControlWidget
---@field ZoomOutKeyWidget UControlWidget
