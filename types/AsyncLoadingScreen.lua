...
---@class FMotorTownLayoutSettings
---@field TipAlignment FWidgetAlignment
---@field LoadingWidgetAlignment FWidgetAlignment
---@field TipPadding FMargin
---@field LoadingWidgetPadding FMargin
---@field TipBorderBackground FSlateBrush
---@field LoadingWidgetBorderBackground FSlateBrush
local FMotorTownLayoutSettings = {}
...
---@field MotorTown FMotorTownLayoutSettings
