...
---@class AIT_Firework_05_C : AActor
...
---@field NS_Firework_Large_01 UNiagaraComponent
...
---@field bUsed boolean
local AIT_Firework_05_C = {}

function AIT_Firework_05_C:ReceiveBeginPlay() end
function AIT_Firework_05_C:Ignite() end
---@param Interactor AActor
---@param Param1 float
function AIT_Firework_05_C:HandleUse(Interactor, Param1) end
---@param EntryPoint int32
function AIT_Firework_05_C:ExecuteUbergraph_IT_Firework_05(EntryPoint) end
