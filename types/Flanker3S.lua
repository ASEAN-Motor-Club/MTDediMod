...
---@class AFlanker3S_C : AMTVehicleBaseBP_C
---@field TailGate UMTVehicleDoorComponent
---@field SideWall_R UMTVehicleDoorComponent
---@field SideWall_L UMTVehicleDoorComponent
---@field SidePost UStaticMeshComponent
