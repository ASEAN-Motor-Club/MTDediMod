...
set(CMAKE_C_COMPILER "/nix/store/rr64nnycczvx7s1b110qmvqrlfcb6lsm-clang-21.1.8/bin/clang-cl")
set(CMAKE_CXX_COMPILER "/nix/store/rr64nnycczvx7s1b110qmvqrlfcb6lsm-clang-21.1.8/bin/clang-cl")
...
set(CMAKE_C_FLAGS_RELEASE_INIT "/MD /Zi /O2 /Ob2 /DNDEBUG")
set(CMAKE_CXX_FLAGS_RELEASE_INIT "/MD /Zi /O2 /Ob2 /DNDEBUG")
...
# Generate PDB debug symbols for crash-dump analysis
set(CMAKE_EXE_LINKER_FLAGS "${CMAKE_EXE_LINKER_FLAGS} ${XWIN_LIB_FLAGS_STR} /DEBUG:FULL")
set(CMAKE_SHARED_LINKER_FLAGS "${CMAKE_SHARED_LINKER_FLAGS} ${XWIN_LIB_FLAGS_STR} /DEBUG:FULL")
set(CMAKE_MODULE_LINKER_FLAGS "${CMAKE_MODULE_LINKER_FLAGS} ${XWIN_LIB_FLAGS_STR} /DEBUG:FULL")
